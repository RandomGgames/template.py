...
# def load_cache(path: Path | str = "cache.json") -> dict:
#     """
#     Loads a cache from the given path.

#     Args:
#     path (typing.Union[Path, str], optional): The path of the cache file to load. Defaults to "cache.json".
...
# def save_cache(data: dict, path: Path | str = "cache.json") -> None:
#     """
#     Saves the given cache data to the given path.

#     Args:
#     data (dict): The cache data to save.
#     path (typing.Union[Path, str], optional): The path of the cache file to save. Defaults to "cache.json".
#     """
